  ...
  return (
    <div className="pt-24 pb-24 relative px-4 xl:px-0">
      <div className="max-w-[1296px] mx-auto relative z-20">
        <h2
          data-aos="fade-up"
          className=" font-extrabold xl:leading-[65px] text-[30px] md:text-[40px] xl:text-[50px] text-center "
        >
          Endless
        ...
        <p
          data-aos="fade-up"
          className="text-center md:text-[20px] font-medium py-4"
        >
        ...
        <div className="grid md:grid-cols-12 gap-6 pt-12 relative z-10">
          <div
            data-aos="fade-up"
            className="md:col-span-7 bg-[#F1F1F1] p-[40px_35px] rounded-[45px]"
          >
            <div className="i">
              <Image
          ...
          <div
            data-aos="fade-up"
            className="md:col-span-5 bg-[#F1F1F1] p-[0px_35px_40px_35px] rounded-[45px]"
          >
            ...
            <p className="font-medium md:text-[20px]">
              Automate the management of inbound{" "}
              <br className="hidden lg:block" />
          ...
          <div
            data-aos="fade-up"
            className="md:col-span-6 lg:col-span-4 bg-[#F1F1F1] p-[40px_35px_40px_35px] rounded-[45px]"
          >
          ...
          <div
            data-aos="fade-up"
            className="md:col-span-6 lg:col-span-5 bg-[#F1F1F1] p-[0px_35px_40px_35px] rounded-[45px]"
          >
          ...
          <div
            data-aos="fade-up"
            className="md:col-span-12 lg:col-span-7 bg-[#F1F1F1] p-[40px_35px] rounded-[45px] grid md:grid-cols-2"
          >
            <div className="md:pt-[200px]">
              ...
              <p className="font-medium md:text-[20px]">
                Automatically answer frequently{" "}
                <br className="hidden lg:block" />
        ...
        <div className="text-center pt-12 relative " style={{ zIndex: 99 }}>
          <Link
            href="/"
        ...
        <div className="integrate pt-16 relative">
          <div className="relative z-20">
            ...
            <Image
              ...
              alt="group"
            />
            <p data-aos="fade-up" className="mtfont-medium text-lg text-center">
              Streamline workflows by connecting your favorite tools View
              integrations
            </p>
            <div className="text-center pt-6" style={{ zIndex: 99 }}>
              <Link
                href="/"
                className="col-span-2 inline-block px-[20px] py-[14px] text-center text-white bg-gradient-to-b from-[#779DFF] to-[#2D68FF] backdrop-blur-[25px] rounded-[25px] font-semibold"
              >
