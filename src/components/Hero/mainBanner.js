  ...
  return (
    <div className="pt-32 lg:pt-44 relative overflow-hidde px-4 xl:px-0">
      <div className="relative" style={{ zIndex: 50 }}>
        <div
          className="mx-auto flex w-[230px] items-center p-[8px_10px] bg-white border border-[#BFCFF3] rounded-[40px]"
          style={{ boxShadow: "0px 6px 41px 14px rgba(12, 15, 27, 0.08)" }}
        >
          <Image src="/images/grp.png" width={60} height={25} alt="group" />
          <p className="font-inter ml-2">3,500+ Pro Users</p>
        </div>

        <h1 className="font-extrabold xl:leading-[125px] pt-4 text-5xl md:text-7xl lg:text-[85px] xl:text-[105px] text-center ">
          Al
